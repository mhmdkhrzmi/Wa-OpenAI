...
- Ganti ApiKey OpenAI pada file [key.json](https://github.com/mhmdkhrzmi/Wa-OpenAI/blob/844f41c362250bed10857443c013cbb454807e87/key.json#L2)
...
```bash
$ git clone https://github.com/mhmdkhrzmi/Wa-OpenAI
$ cd Wa-OpenAI
$ npm install
$ node index.js
```
...
## Donate
<a href="https://shorturl.at/yX024" target="_blank"><img src="https://user-images.githubusercontent.com/26188697/180601310-e82c63e4-412b-4c36-b7b5-7ba713c80380.png" alt="Donate For Yusril" height="41" width="174"></a>

Copyright (c) 2023 M Haisyam K
